...
#if defined(MSDOS_SUPPORTED_ANTIQUE) || defined(AMIGA) || defined(WIN32)
...
#ifdef WIN32
          wattrset(Levelw,((int)(last_attr))<<24);
#else
...
#endif
#ifdef WIN32
  /* First, the basic color-on-black colors */
  init_pair(COL_BLACK >> 8, 
            0,
            0);
  init_pair(COL_WHITE >> 8,
            COLOR_WHITE, 
            0 );
  init_pair(COL_RED >> 8,
            COLOR_RED, 
            0 );
  init_pair(COL_GREEN >> 8,
            COLOR_GREEN, 
            0 );
  init_pair(COL_BLUE >> 8,
            COLOR_BLUE, 
            0 );
  init_pair(COL_CYAN >> 8,
            COLOR_CYAN, 
            0 );
  init_pair(COL_PURPLE >> 8,
            COLOR_MAGENTA, 
            0 );
  init_pair(COL_BROWN >> 8,
            COLOR_YELLOW, 
            0 );
  init_pair(COL_BRIGHT_WHITE >> 8, 
            COLOR_WHITE | FOREGROUND_INTENSITY, 
            0 );
  init_pair(COL_LIGHT_RED >> 8,
            COLOR_RED | FOREGROUND_INTENSITY, 
            0 );
  init_pair(COL_LIGHT_GREEN >> 8,
            COLOR_GREEN | FOREGROUND_INTENSITY, 
            0 );
  init_pair(COL_LIGHT_BLUE >> 8,
            COLOR_BLUE | FOREGROUND_INTENSITY, 
            0 );
  init_pair(COL_LIGHT_CYAN >> 8,
            COLOR_CYAN | FOREGROUND_INTENSITY, 
            0 );
  init_pair(COL_LIGHT_PURPLE >> 8,
            COLOR_MAGENTA | FOREGROUND_INTENSITY, 
            0 );
  init_pair(COL_YELLOW >> 8, 
            COLOR_YELLOW | FOREGROUND_INTENSITY, 
            0 );

  /* Next, color-on-white colors */
  init_pair( ( COL_BLACK | COL_BG_WHITE ) >> 8,
             BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_WHITE | COL_BG_WHITE ) >> 8,
             COLOR_WHITE | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_RED | COL_BG_WHITE ) >> 8,
             COLOR_RED | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_GREEN | COL_BG_WHITE ) >> 8,
             COLOR_GREEN | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_BLUE | COL_BG_WHITE ) >> 8,
             COLOR_BLUE | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_CYAN | COL_BG_WHITE ) >> 8,
             COLOR_CYAN | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_PURPLE | COL_BG_WHITE ) >> 8,
             COLOR_MAGENTA | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_BROWN | COL_BG_WHITE ) >> 8,
             COLOR_YELLOW | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_BRIGHT_WHITE | COL_BG_WHITE ) >> 8,
             COLOR_WHITE | FOREGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_LIGHT_RED | COL_BG_WHITE ) >> 8,
             COLOR_RED | FOREGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_LIGHT_GREEN | COL_BG_WHITE ) >> 8,
             COLOR_GREEN | FOREGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_LIGHT_BLUE | COL_BG_WHITE ) >> 8,
             COLOR_BLUE | FOREGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_LIGHT_CYAN | COL_BG_WHITE ) >> 8,
             COLOR_CYAN | FOREGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_LIGHT_PURPLE | COL_BG_WHITE ) >> 8,
             COLOR_MAGENTA | FOREGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_YELLOW | COL_BG_WHITE ) >> 8,
             COLOR_YELLOW | FOREGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE, 
             0 );

  /* Finally, a set of arbitrary pairs, color on "best background" (based on
     the defs in minit.h */
  init_pair( ( COL_BLACK | 0x2000 ) >> 8,
             BACKGROUND_RED,
             0 );
  init_pair( ( COL_WHITE | 0x2000 ) >> 8,
             COLOR_WHITE | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_RED | 0x2000 ) >> 8,
             COLOR_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_GREEN | 0x2000 ) >> 8,
             COLOR_GREEN | BACKGROUND_RED | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_BLUE | 0x2000 ) >> 8,
             COLOR_BLUE | BACKGROUND_RED | BACKGROUND_GREEN,
             0 );
  init_pair( ( COL_CYAN | 0x2000 ) >> 8,
             COLOR_CYAN | BACKGROUND_RED,
             0 );
  init_pair( ( COL_PURPLE | 0x2000 ) >> 8,
             COLOR_MAGENTA | BACKGROUND_GREEN,
             0 );
  init_pair( ( COL_BROWN | 0x2000 ) >> 8,
             COLOR_YELLOW | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_BRIGHT_WHITE | 0x2000 ) >> 8,
             COLOR_WHITE | FOREGROUND_INTENSITY | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_LIGHT_RED | 0x2000 ) >> 8,
             COLOR_RED | FOREGROUND_INTENSITY |BACKGROUND_GREEN | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_LIGHT_GREEN | 0x2000 ) >> 8,
             COLOR_GREEN | FOREGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_BLUE,
             0 );
  init_pair( ( COL_LIGHT_BLUE | 0x2000 ) >> 8,
             COLOR_BLUE | FOREGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_GREEN,
             0 );
  init_pair( ( COL_LIGHT_CYAN | 0x2000 ) >> 8,
             COLOR_CYAN | FOREGROUND_INTENSITY | BACKGROUND_RED,
             0 );
  init_pair( ( COL_LIGHT_PURPLE | 0x2000 ) >> 8,
             COLOR_MAGENTA | FOREGROUND_INTENSITY | BACKGROUND_GREEN,
             0 );
  init_pair( ( COL_YELLOW | 0x2000 ) >> 8,
             COLOR_YELLOW | FOREGROUND_INTENSITY | BACKGROUND_BLUE,
             0 );
#endif
...
void drawplayer()
{
  ...
  if (Current_Environment == E_COUNTRYSIDE) {
...
#ifdef WIN32
          wattrset(Levelw, ((int)(CHARATTR(c)))<<24);
#else
    ...
    if (optionp(SHOW_COLOUR))
#ifdef WIN32
      wattrset(Levelw, ((int)(CHARATTR(PLAYER)))<<24);
#else
...
int i,j;
{
  if (inbounds(i,j)) {
    ...
    if (! offscreen(j)) {
      wmove(Levelw,screenmod(j),i);
#ifdef WIN32
      wattrset(Levelw, ((int)(CHARATTR(SPACE)))<<24);
#else
...
struct monster *m;
{
  if (! offscreen(m->y)) {
    ...
    if (optionp(SHOW_COLOUR))
#ifdef WIN32
      wattrset(Levelw, ((int)(CHARATTR(m->monchar)))<<24);
#else
...
int x,y;
{
  if (! offscreen(y)) {
    ...
    if (optionp(SHOW_COLOUR))
#ifdef WIN32
      wattrset(Levelw, ((int)(CHARATTR(pyx)))<<24);
#else
...
void drawomega()
{
  ...
  for(i=0;i<7;i++) {
      ...
      if (optionp(SHOW_COLOUR))
#ifdef WIN32
        wattrset(stdscr, ((int)(CHARATTR(CLR(LIGHT_BLUE))))<<24);
#else
      ...
      if (optionp(SHOW_COLOUR))
#ifdef WIN32
        wattrset(stdscr, ((int)(CHARATTR(CLR(CYAN))))<<24);
#else
      ...
      if (optionp(SHOW_COLOUR))
#ifdef WIN32
        wattrset(stdscr, ((int)(CHARATTR(CLR(BLUE))))<<24);
#else
...
#ifdef WIN32
  wattrset(stdscr, ((int)(CHARATTR(CLR(WHITE))))<<24);
#else
...
{
#ifdef WIN32
  wattrset(Levelw, ((int)(CHARATTR(CLR(WHITE))))<<24);
#else
